...
>>>>>>> 06e8f6a5977632ed61073819b54ed492a221024f
          ...
          <div>
            <a
              href={
                "https://marketplace.reservoir.tools/collection/ethereum/0xe0ba5a6fc8209e225a9937ce1dfb397f18ad402f"
              }
              css={css`
                margin-top: 40px;
...
<<<<<<< HEAD
  ...
  const collectiveProbability = new BigNumber(1).minus(
    new BigNumber(1).minus(probability).pow(42)
  );
  ...
  return (
    ...
    >
      <MaxWidth>
        <Padding>
          <div css={css``}>
            <h4>What happened so far.</h4>
            <p>
              In March, we raised about $16.000, which will be donated to Breast
              Cancer Now. In addition to this, 3 ETH (25% of the project's
              income) has been allocated to{" "}
              <a href={"0x47746e3563dc8c3ec09878907f8ce3a3f20082f0"}>
                its treasury
              </a>{" "}
              to support the project over the next couple of years in terms of
              gas and random generator fees.
            </p>
            <p>
              In total, 42 pieces have been minted and are in circulation. 8 are
...
<<<<<<< HEAD
                ...
                <div>
                  ...
                  <p>
                    For each item sold, 75% of the purchase price, plus 100% of
                    any secondary royalties, will be donated to Breast Cancer
                    Now, a charity registered in England and Wales (No.
                    1160558), Scotland (SC045584) and Isle of Man (No. 1200).
                  </p>
                  <p>
                    You can follow the flow of funds at{" "}
                    <a
                      href={
                        "https://etherscan.io/address/0x83cB05402E875B5ca953e6eAa639F723d92BC4fc#internaltx"
                      }
                    >
                      this address
                    </a>
                  ...
                  <p>
                    The remaining funds are used to cover gas fees for contract
                    deployment and maintaining the random generator.
                  </p>
                </div>
              </div>
            </div>
          ...
          <h4 style={{ textAlign: "right" }}>What is happening now.</h4>
          <p style={{ textAlign: "right" }}>
            Over the next 5 years, each piece faces a potential breast cancer
            diagnosis.
          </p>
          <div
            css={css`
    ...
    >
      ...
      >
        <h3>
          <img
            src={"/icons/brush.png"}
            style={{ height: "1.3em", paddingRight: "10px" }}
          />
          Artist Statement
        </h3>
        <p>
          One day, when I was eleven years old, I came home from school to find
          my mom crying. At the time, no one explained to me what happened, and
          I only later learnt that the reason: my aunt got breast cancer. After
          going through chemotherapy, surgery and radiotherapy, she was able to
          defeat the cancer.
        </p>
        <p>
          Then twenty years later, in late 2019, my mom was diagnosed with
          breast cancer as well. As a woman from the next generation, I am at a
          high risk of getting this cancer myself. While that seems frightening,
          when I look back and contrast my mom's with my aunt's treatment, I can
          see a big improvement. We have come a long way.
        </p>
        <p>
          I dedicate this project to my mom and to all those who have fought,
          are fighting and are continuing the fight against breast cancer.
        </p>
        <p>
          2020 was a tough year for everyone, but I know from my mom's personal
          experience that this time is especially hard on people fighting
          cancer. In addition to their illness, patients have to deal with all
          kinds of Covid-induced limitations. With this project we want them to
    ...
    >
      <Padding>
        ...
        >
          ...
          <div className={"fact"}>
            <div className={"number"}>1 in 8</div>
            <div className={"text"}>
              probability a woman will experience breast cancer.
            </div>
            <div className={"detail"}>
              Accordingly, there is a 1/8 chance for each NFT to be diagnosed.
              This is random and unpredictable, and the creators do not control
              the process or know the outcome.
            </div>
          </div>

          <div className={"fact"}>
            <div className={"number"}>60</div>
            <div className={"text"}>hand-designed, unique illustrations.</div>
            <div className={"detail"}>
              Each illustration is a lovingly created, one-of-a kind piece, and
              if diagnosed, will transform to represent a woman post-surgery.
              Because we cannot predict the outcome, two versions of each
          ...
          <div className={"fact"}>
            ...
            <div className={"detail"}>
              If a token is diagnosed, secondary sale royalties increase to 15%.
              All secondary sale royalties go to our charity partner,{" "}
              <a href={"https://breastcancernow.org/"}>Breast Cancer Now UK</a>.
            </div>
          </div>
...
<<<<<<< HEAD
        <p className={"detail"}>
          ...
          <span>
            <a href="https://etherscan.io/address/0xe0ba5a6fc8209e225a9937ce1dfb397f18ad402f">
              Etherscan
            </a>
          </span>{" "}
          &bull;{" "}
...
<<<<<<< HEAD
          ...
          >
            <li>
              <div>
                ...
                <div className={"hint"}>
                  Hint: Only fund the contract when you want to request
                  randomness. Since anyone can call the contract as often as
                  they want, it is easy to drain its balance.
                </div>
              </div>
            </li>
            <li>
              <div>
                ...
                <div className={"hint"}>
                  Wait roughly two minutes, then verify on-chain that Chainlink
                  has provided a random number.
                </div>
              </div>
            </li>
            <li>
              <div>
                After a minute or two, call the <code>applyRoll()</code>{" "}
                function.
              </div>
            </li>
          </ol>
        ...
        <div className={"section"}>
          ...
          <p>
            ...
            <a href={"https://zora.engineering/protocol/smart-contracts"}>
              Zora Protocol
            </a>
            , embedding within each token its own marketplace. Owners have the
...
<<<<<<< HEAD
          ...
          <p>
            ...
            accessible. For this reason, all artwork is stored on the Ethereum
            blockchain as SVG code. Further, to improve their accessibility
...
<<<<<<< HEAD
            ...
            currently in use. Specifically, the contract exposes functions to
...
>>>>>>> 06e8f6a5977632ed61073819b54ed492a221024f
          ...
          <p>
            ...
            <a href={"https://github.com/ethereum/EIPs/issues/2571"}>
              ERC-2571
            </a>{" "}
            or{" "}
            <a href={"https://github.com/ethereum/EIPs/issues/2665"}>
              ERC-2665
            </a>
            . The former has the undesirable effect of disabling simple
            transfers, and the latter seems to lack traction.
          </p>
        </div>
      </Padding>
    </div>
          ...
          >
            <div style={{ flex: 1, marginRight: "30px" }}>
              <h1>
                ...
                <br />A unique, 5-year experiment.
              </h1>
              <p>
                1 in 8 woman will develop invasive breast cancer over the course
                of their lives. 60 unique illustrations represent women of every
                age and background, and face the same, unpredictable odds. When
                diagnosed, the illustration will update.
              </p>
            </div>
