...
export function Content(props: {
  ...
  return <MaxWidth>
    ...
    `}>
      ...
      <div style={{textAlign: 'center'}}>
        <img src={"/img/announcement-diagram2.png"} style={{height: '260px', textAlign: 'center'}} alt={"Diagram explaining the smart contract randomness generator logic."} />
      </div>
      <p>
      ...
      <p>
        ...
        generated by Chainlink VRF, creating a highly transparent process that is unrivalled by other randomness providers,” said name and title.
