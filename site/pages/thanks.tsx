  ...
  return (
    <MaxWidth>
      ...
      >
        ...
        <p>
          The following illustrations, parts of this interactive experiment, now
          belong to you.
        </p>
        <MyGallery />
        <p>
          You can also find the full collection on{" "}
          <a
            href={
        ...
        <p>
          Over the next 10 years, there is a 12% chance (1 in 8) that your
          pieces will be diagnosed with breast cancer. This will be reflected in
          your NFT. If so, secondary sale royalties will increase from 5% to 15%
...
export function MyGallery() {
  ...
  const [data, setData] = useState<null | { name: string; url: string }[]>(
    null
  );
  ...
  if (!data?.length) {
    return <em>You do not yet own any tokens.</em>;
  }
